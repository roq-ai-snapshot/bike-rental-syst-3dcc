  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Bike Rental System - Revolutionizing Urban Mobility in Indian Cities with Seamless, Efficient, and Eco-friendly Bike Rentals."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1472709171579-139831cdf19e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxiaWtlJTIwcmVudGFsfGVufDB8fHx8MTY5MTk5NjY3MHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Bike Rental System - Revolutionizing Urban Mobility in Indian Cities with Seamless, Efficient, and Eco-friendly Bike Rentals.`}
            </Text>
            <Box
